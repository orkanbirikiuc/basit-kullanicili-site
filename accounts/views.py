...
from .forms import (
    ...
    ResendActivationCodeForm, ResendActivationCodeViaEmailForm, ChangeProfileForm, ChangeEmailForm, ChangePasswordForm,
)
...
class SignUpView(GuestOnlyView, FormView):
    ...
    def form_valid(self, form):
        ...
        if settings.ENABLE_USER_ACTIVATION:
            ...
            messages.success(request, _('Başarılı bir şekilde kayıt oldunuz!'))
...
class ChangeEmailActivateView(View):
    ...
    def get(request, code):
        ...
        messages.success(request, _('Eposta adresi başarılı bir şekilde değiştirildi!'))
...
class ChangePasswordView(BasePasswordChangeView):
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, _('Şifreniz değiştirildi.'))
